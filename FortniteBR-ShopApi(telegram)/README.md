...
Open the bot.2Github.py file and change the non-centering paths.
To find out your API hash and API id go to (https://my.telegram.org/auth) and enter your phone number. Go to your telegram and enter the code that came to you in the bar. After that copy the Ash API and the API id and enter it in the appropriate paths.
After that go to @BotFather, create a bot and enter Bot Token in the "Bot Token" path
...
- File by: [H8djlorenzo] (https://github.com/h8djlorenzo
